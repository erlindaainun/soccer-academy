...
function store()
{
    ...
    $target_dir = "../server/uploads/gallery/";
    ...
    if (file_exists($target_file)) {
        ...
        header("Location:/server/gallery.php?page=create&errorMsg=already_exist");
        $uploadOk = 0;
    }
    ...
    if ($_FILES["fileToUpload"]["size"] > 1000000) {
        ...
        header("Location:/server/gallery.php?page=create&errorMsg=file_size");
        $uploadOk = 0;
    }
    ...
    if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
        ...
        header("Location:/server/gallery.php?page=create&errorMsg=file_format");
        $uploadOk = 0;
    }
...
function update()
{
    ...
    if ($check_file_to_upload['name'] != null) {
        ...
        if (file_exists($target_file)) {
            // $message['already_exist'] = "Sorry, file already exists.";
            header("Location:/server/gallery.php?page=edit&id=" . $_POST['id'] . '&errorMsg=already_exist');
            $uploadOk = 0;
        }
        ...
        if ($_FILES["fileToUpload"]["size"] > 1000000) {
            // $message['file_size'] = "Sorry, your file is too large.";
            header("Location:/server/gallery.php?page=edit&id=" . $_POST['id'] . '&errorMsg=file_size');
            $uploadOk = 0;
        }
        ...
        if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
            // $message['file_format'] = "Sorry, only JPG, JPEG & PNG files are allowed.";
            header("Location:/server/gallery.php?page=edit&id=" . $_POST['id'] . '&errorMsg=file_format');
            $uploadOk = 0;
        }
