...
<head>
    ...
    <title>Sejarah | SSB Tunas Jaya Duriangkang Official Website</title>
        ...
        <section id="contact" class="contact">
            <div class="container">
                <div class="text-center border-bottom">
                    <div class="overflow-hidden" style="max-height: 30vh;" data-aos="fade-up">
                    ...
                    <h1 class="display-4 fw-bold" data-aos="fade-up">Sejarah</h1>
                    <div class="col-lg-8 mx-auto" data-aos="fade-up">
                        <p class="lead mb-4">SSB TUNAS JAYA DURIANGKANG sebuah yayasan dan organisasi yang bergerak dibidang sepak bola yang menaungi SSB Tunas Jaya Duriangkang. SSB Tunas Jaya Duriangkang sendiri adalah sekolah sepak bola yangbertujuan untuk pembinaan bola anak-anak di usia dini. Perlu disadari bersama bahwa upaya peningkatan kualitas persepak bolaan Nasional haruslah di awali dari pembinaan sepak bola usia muda mulai dari usia 6 hingga usia 18 tahun sebagai awal pembentukan pesepakbola masa depan. Tunas Jaya Duriangkang terbentuk pada tanggal 21 Januari 2017. SSB Tunas Jaya Duriangkang atau yang di sebut juga dengan TJD (Tunas Jaya Duriangkang) memiliki julukan Laskar Kalajengking. </p>
                    ...
                    <h1 class="display-4 fw-bold" data-aos="fade-up">Legalitas</h1>
                    <div class="col-lg-8 mx-auto" data-aos="fade-up">
                        <p class="lead mb-4">Pada tanggal 5 Desember 2019 Tunas Jaya Duriangkang resmi berbadan hukum sesuai dengan keputusan Menteri Hukum dan Hak Asasi Manusia No : AHU-0018254.AH.01.04 TAHUN 2019 oleh Direktur Jenderal Administrasi Hukum Umum : CAHYO RAHADIAN MUZHAR,S.H.,LLM</p>
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
                            <!-- <button type="button" class="btn btn-primary btn-lg px-4 me-sm-3">Primary button</button>
                            <button type="button" class="btn btn-outline-secondary btn-lg px-4">Secondary</button> -->
                        </div>
