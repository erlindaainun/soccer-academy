...
<head>
  ...
  <title>Admin SSB | Prestasi</title>
  <?php
  include 'session.php';
            ...
            if ($page == 'create' || $page == 'edit') {
              ...
              if ($page == 'edit' && isset($_GET['id'])) {
                ...
                <?php
                  ...
                  echo '<script>document.addEventListener("DOMContentLoaded", function() {editAchievement(' . $id . ')})</script>';
  ...
  <script>
    $(function() {
      $("#example1").DataTable({
        ...
        "ajax": '/api/achievement.php',
        "columnDefs": [{
          "targets": 3,
          "data": 3,
          "render": function(data, type, full, meta) {
            return '<a class="btn btn-primary btn-sm" href="/server/achievement.php?page=view&id=' + data + '"><i class="fas fa-eye"></i> Lihat</a> ' +
              '<a class="btn btn-info btn-sm" href="/server/achievement.php?page=edit&id=' + data + '"><i class="fas fa-pencil-alt"></i> Ubah</a> ' +
    ...
    function deleteAchievement(id) {
      Swal.fire({
        title: 'Apakah anda yakin hapus prestasi ini?',
