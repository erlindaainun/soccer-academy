            ...
            if ($page == 'create' || $page == 'edit') {
              ...
              if ($page == 'edit' && isset($_GET['id'])) {
                ...
                <?php
                  ...
                  echo '<script>document.addEventListener("DOMContentLoaded", function() {editGallery(' . $id . ')})</script>';
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div style="margin-bottom: 10px;" class="row">
                      <div class="col-lg-12">
                        <a class="btn btn-success" href="gallery.php?page=create">
  ...
  <script>
    $(function() {
      $("#example1").DataTable({
        ...
        "ajax": '/api/gallery.php',
        "columnDefs": [{
          "targets": 2,
          "data": 2,
          "render": function(data, type, full, meta) {
            return '<a class="btn btn-primary btn-sm" href="/server/gallery.php?page=view&id=' + data + '"><i class="fas fa-eye"></i> Lihat</a>' +
    ...
    function deleteGallery(id) {
      Swal.fire({
        title: 'Apakah anda yakin hapus galeri ini?',
