...
<head>
  ...
  <title>Registrasi | SSB Tunas Jaya Duriangkang Official Website</title>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-sm-6">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Registrasi Anggota</h5>
                <p class="card-text">Merupakan form registrasi anggota.</p>
